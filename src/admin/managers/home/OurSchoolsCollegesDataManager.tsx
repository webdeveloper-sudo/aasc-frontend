...
const OurSchoolsCollegesDataManager: React.FC = () => {
  ...
  const [doc, setDoc] = useState<SchoolsCollegesData | null>(null);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setError(e.message || "Failed to load schools & colleges data");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="collection-manager p-6 min-h-screen mx-auto">
      ...
      <div className="border border-gray-300 rounded-lg p-6 bg-white mb-8">
        <Heading
          title="Schools & Colleges Logos Management"
          size="lg"
          align="left"
        />
        ...
        <div className="flex items-center justify-between mb-6 pt-4 border-b border-gray-200 pb-4">
          ...
          <p className="text-xs text-gray-500">
            Logos are permanent once saved. Delete and re-upload to change.
          </p>
        </div>
          ...
          <div className="max-w-sm">
            <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 bg-gray-50 flex flex-col items-center justify-center hover:border-blue-400 hover:bg-blue-50 transition-all group">
              ...
              <p className="text-sm text-gray-500 mt-3 group-hover:text-gray-700 transition-colors">
                Upload a new school/college logo
              </p>
      ...
      <ConfirmationPopup
        ...
        title="Add New Logo?"
        message="Add this logo to the schools & colleges section? Once saved, it cannot be replaced - only deleted."
